...
#ifndef _NAFE13388_H_
#define _NAFE13388_H_
...
#define NAFE_CMD_CLEAR_ALARM 0x0012
...
#define NAFE_REG_SERIAL0 0x7C
#define NAFE_REG_SERIAL1 0x7D
#define NAFE_REG_PRODREV 0x7E
#define NAFE_REG_PRODID 0x7F
...
typedef enum
{
    ...
    kNafeSampleMode_scsrNonBlock,
    kNafeSampleMode_sccrNonBlock,
    kNafeSampleMode_mcmrNonBlock,
    kNafeSampleMode_mccrNonBlock,
    kNafeSampleMode_sccrDma,
    kNafeSampleMode_mccrDma,
} NAFE_sampleMode_t;
...
typedef enum
{
    kNafeInterrupt_spi = 0u,
    kNafeInterrupt_readyPin
} NAFE_interruptSrc_t;
...
typedef enum
{
    kNafeAdcFilterReset_noResetOnStart = 0u,
    kNafeAdcFilterReset_resetOnStart,
} NAFE_adcFilterReset_t;

typedef enum
{
    kNafeChChop_normalMode = 0u,
    kNafeChChop_precisionMode,
} NAFE_chChop_t;
...
typedef enum
{
    kNafeViexVi_voltage = 0u,
    kNafeViexVi_current
} NAFE_viexVi_t;

typedef enum
{
    kNafeViexPol_positive = 0u,
    kNafeViexPol_negative
} NAFE_viexPol_t;

typedef enum
{
    kNafeViexChop_disable = 0u,
    kNafeViexChop_enable
} NAFE_viexChop_t;

typedef enum
{
    kNafeViexMag_0mV_0uA = 0u,
    kNafeViexMag_600uV_100nA,
    kNafeViexMag_6mV_1uA,
    kNafeViexMag_12mV_2uA,
    kNafeViexMag_23mV_4uA,
    kNafeViexMag_47mV_8uA,
    kNafeViexMag_94mV_16uA,
    kNafeViexMag_188mV_31uA,
    kNafeViexMag_375mV_62uA,
    kNafeViexMag_750mV_125uA,
    kNafeViexMag_1p5V_250uA,
    kNafeViexMag_2p25V_375uA,
    kNafeViexMag_4p5V_750uA,
    kNafeViexMag_6V_1mA,
    kNafeViexMag_9V_1p5mA,
    kNafeViexMag_12V_2mA,
} NAFE_viexMag_t;


typedef enum
{
    kNafeViexAipEn_none = 0u,
    kNafeViexAipEn_ai1p,
    kNafeViexAipEn_ai2p,
    kNafeViexAipEn_ai3p,
    kNafeViexAipEn_ai4p
...
typedef enum
{
    kNafeReadResult_singleFrame,            /* Read multiple conversion results in single SPI frame (CS keeps to low). */
    kNafeReadResult_multiFrame              /* Read multiple conversion results in separate SPI frames. */
} NAFE_readResultFrameMode_t;
...
typedef enum
{
    kNafeNonBlockXferState_initial = 0u,
    kNafeNonBlockXferState_modeCmdSent,
    kNafeNonBlockXferState_waitForReady,
    kNafeNonBlockXferState_ready,
    kNafeNonBlockXferState_rxClkSending,
    kNafeNonBlockXferState_dataReceived,
    kNafeNonBlockXferState_done,
} NAFE_nonBlockXferState_t;
...
typedef struct
{
    ...
    NAFE_adcFilterReset_t filterReset;
    NAFE_chChop_t chChop;
    NAFE_adcSettling_t adcSettling;
    NAFE_viexVi_t viexVi;
    NAFE_viexPol_t viexPol;
    NAFE_viexMag_t viexMag;
    NAFE_viexChop_t viexChop;
    NAFE_viexAipEn_t viexAipEn;
    NAFE_viexAinEn_t viexAinEn;
    NAFE_tempCorr_t tcc;
} NAFE_chnConfig_t;
...
typedef struct
{
    ...
    NAFE_readResultFrameMode_t readResultFrameMode;
...
typedef struct
{
    ...
    NAFE_nonBlockXferState_t nonBlockXferState;     /* For interrupt and DMA approaches.*/
